...
<div class="bedcrumb-wrap row justify-content-between align-items-center">
    <div class="col-auto">
        <div class="page-name">Update coupon</div>
    </div>
    <div class="col-auto">
        <div class="bedcrumb-list">
            <ul class="d-flex">
                <li><a href="{{url('admin/dashboard')}}">Update coupon</a></li>
                <li>Update coupon</li>
            </ul>
        </div>
    </div>
        ...
        <div class="row g-3">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="coupon_discount" class="form-control isnumber" placeholder="Discount" aria-label="Discount" aria-describedby="basic-addon2" maxlength="3" minlength="1" value="{{$coupon->coupon_discount}}" required>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control" name="coupon_code" id="coupon_code" placeholder="Coupon Code" value="{{$coupon->coupon_code}}" required>
                    @error('coupon_code')
                ...
                <div class="select-wrap">
                    ...
                    <select class="select2 form-select" name="coupon_category[]" multiple required>
                        @foreach ($productcategory as $item)
                            <option value="{{$item->id}}" @if(in_array($item->id, explode(',', $coupon->coupon_category))) selected @endif>{{$item->title}}</option>
                        @endforeach
                    </select>
