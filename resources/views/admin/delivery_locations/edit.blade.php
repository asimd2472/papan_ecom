        ...
        <div class="row g-3">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="location" class="form-control" placeholder="Delivery Locations" aria-label="location" aria-describedby="basic-addon2" required value="{{$deliveryLocations->location ?? ''}}">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control" name="charges" id="charges" placeholder="Charges" value="{{$deliveryLocations->charges ?? ''}}">
                    @error('charges')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
            </div>
            <input type="hidden" name="id" id="id" value="{{$deliveryLocations->id ?? ''}}">
            <div class="col-md-12">
                <div class="input-wrap">
