            ...
            <div class="row g-3" id="with_out_variation" style="display: none">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="input-wrap">
                        ...
                        <input type="text" class="form-control input-style isnumber" name="product_price" id="product_price" placeholder="Price">
                        @error('product_price')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="input-wrap">
                        ...
                        <input type="text" class="form-control input-style isnumber" name="product_offerprice" id="product_offerprice" placeholder="Discount Price">
                ...
                <div class="dashboard-white-box">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="input-wrap">
                                <label class="lable-head">Type</label>
                                <input type="text" class="form-control input-style" name="attribute[0][attribute_name]" id="" placeholder="e.g : Profishiency Casting Reels">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="input-wrap">
                                        ...
                                        <input type="text" class="form-control input-style" name="attribute[0][item][0][name]" id="" placeholder="e.g : P413641LR">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                    <div class="input-wrap">
                                        <label class="lable-head">Stock</label>
                                        <input type="number" class="form-control input-style" name="attribute[0][item][0][stock]" id="" placeholder="Stock">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                    <div class="input-wrap">
                                        <label class="lable-head">Price</label>
                                        <input type="number" class="form-control input-style" name="attribute[0][item][0][price]" id="" placeholder="Price">
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                            <div class="input-wrap">
                                                ...
                                                <input type="text" class="form-control input-style" name="attribute[0][item][0][retrieve]" id="" placeholder="Retrieve">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                            <div class="input-wrap">
                                                <label class="lable-head">Weight</label>
                                                <input type="text" class="form-control input-style" name="attribute[0][item][0][weight]" id="" placeholder="Weight">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                            <div class="input-wrap">
                                                <label class="lable-head">Gear Ratio</label>
                                                <input type="text" class="form-control input-style" name="attribute[0][item][0][gear_ratio]" id="" placeholder="Gear Ratio">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                            <div class="input-wrap">
                                                <label class="lable-head">Line Cap.</label>
                                                <input type="text" class="form-control input-style" name="attribute[0][item][0][line_cap]" id="" placeholder="Line Cap.">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                            <div class="input-wrap">
                                                <label class="lable-head">Bearings</label>
                                                <input type="text" class="form-control input-style" name="attribute[0][item][0][bearings]" id="" placeholder="Bearings">
                                            </div>
                                        </div>
                                    </div>
                                </div>
