            ...
            <div class="row g-3" id="with_out_variation" @if($products->is_variation=='1') style="display: none" @endif>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="input-wrap">
                        ...
                        <input type="text" class="form-control input-style isnumber" name="product_stock" id="product_stock" placeholder="Stock" value="{{$products->product_stock}}">
                        @error('product_stock')
                            <span class="error">{{ $message }}</span>
                        @enderror
                        <span class="error" id="error_message"></span>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][name]" id="" value="{{$itemProductAttributeItem->name}}" placeholder="e.g : P413641LR" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            <label class="lable-head">Stock</label>
                                            <input type="number" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][stock]" id="" value="{{$itemProductAttributeItem->stock}}" placeholder="Stock" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            <label class="lable-head">Price</label>
                                            <input type="number" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][price]" id="" value="{{$itemProductAttributeItem->price}}" placeholder="Price" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
