...
<div class="bedcrumb-wrap row justify-content-between align-items-center">
    <div class="col-auto">
        <div class="page-name">Add Category</div>
    </div>
    <div class="col-auto">
        ...
        <div class="row g-3">
            <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control input-style" name="title" id="title" placeholder="Category name" required>
                    @error('title')
            ...
            <div class="col-md-12">
              <div class="input-wrap">
                  ...
                  <textarea class="form-control" name="categorydesc" id="categorydesc" rows="5"></textarea>
                  @error('categorydesc')
                      <span class="error">{{ $message }}</span>
                  @enderror
              </div>
