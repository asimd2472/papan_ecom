...
<div class="bedcrumb-wrap row justify-content-between align-items-center">
    <div class="col-auto">
        <div class="page-name">Add Type</div>
    </div>
    <div class="col-auto">
        ...
        <div class="row g-3">
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control input-style" name="typename" id="typename" placeholder="Type name" required>
                    @error('typename')
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="select-wrap">
                    <label class="lable-head">Iamge <sup class="star-mark">*</sup></label>
                    <input type="file" class="form-control" name="typeimage" id="typeimage" required>
                    @error('typeimage')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-md-12">
                <div class="input-wrap">
                    ...
                    <textarea class="form-control" name="typedesc" id="typedesc" rows="5"></textarea>
                    @error('typedesc')
                        <span class="error">{{ $message }}</span>
                    @enderror
                </div>
