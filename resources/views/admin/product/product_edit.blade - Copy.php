            ...
            <div class="row g-3" id="with_out_variation" @if($products->is_variation=='1') style="display: none" @endif>
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="input-wrap">
                        ...
                        <input type="text" class="form-control input-style isnumber" name="product_price" id="product_price" value="{{$products->product_price}}" placeholder="Price">
                        @error('product_price')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="input-wrap">
                        <label class="lable-head">Selling Price</label>
                        <input type="text" class="form-control input-style isnumber" name="product_offerprice" id="product_offerprice" value="{{$products->product_offerprice}}" placeholder="Discount Price">
                ...
                <div class="dashboard-white-box">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="input-wrap">
                                <label class="lable-head">Type</label>
                                <input type="text" class="form-control input-style" name="attribute[{{$item->id}}][attribute_name]" id="" value="{{$item->name}}" placeholder="e.g : Profishiency Casting Reels">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][name]" id="" value="{{$itemProductAttributeItem->name}}" placeholder="e.g : P413641LR">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            <label class="lable-head">Stock</label>
                                            <input type="number" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][stock]" id="" value="{{$itemProductAttributeItem->stock}}" placeholder="Stock">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="input-wrap">
                                            <label class="lable-head">Price</label>
                                            <input type="number" class="form-control input-style" name="attribute[{{$item->id}}][item][{{$itemProductAttributeItem->id}}][price]" id="" value="{{$itemProductAttributeItem->price}}" placeholder="Price">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                                        <div class="select-btn-img">
                                            <label class="lable-head">select image</label>
                                            <button type="button" class="img-select-btn select_image"  data-row_id="{{$keys}}">select image</button>
                                        </div>
                                        @php
                                            $imageArray[]='';
                                        ...
                                        {{-- <input type="hidden" name="attribute[0][item][{{$keys}}][images_name]" id="selected_imgNameArr_{{$keys}}" value="{{$imageString}}"> --}}
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                                <div class="input-wrap">
                                                    <label class="lable-head">Retrieve</label>
                                                    <input type="text" class="form-control input-style" name="attribute[0][item][{{$keys}}][retrieve]" id="" value="{{@$itemProductAttributeItem->ProductAttributeItemSpecification->retrieve}}" placeholder="Retrieve">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                                <div class="input-wrap">
                                                    <label class="lable-head">Weight</label>
                                                    <input type="text" class="form-control input-style" name="attribute[0][item][{{$keys}}][weight]" id="" value="{{@$itemProductAttributeItem->ProductAttributeItemSpecification->weight}}" placeholder="Weight">
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                                <div class="input-wrap">
                                                    <label class="lable-head">Gear Ratio</label>
                                                    <input type="text" class="form-control input-style" name="attribute[0][item][{{$keys}}][gear_ratio]" id="" value="{{@$itemProductAttributeItem->ProductAttributeItemSpecification->gear_ratio}}" placeholder="Gear Ratio">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                                <div class="input-wrap">
                                                    <label class="lable-head">Line Cap.</label>
                                                    <input type="text" class="form-control input-style" name="attribute[0][item][{{$keys}}][line_cap]" id="" value="{{@$itemProductAttributeItem->ProductAttributeItemSpecification->line_cap}}" placeholder="Line Cap.">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                                <div class="input-wrap">
                                                    <label class="lable-head">Bearings</label>
                                                    <input type="text" class="form-control input-style" name="attribute[0][item][{{$keys}}][bearings]" id="" value="{{@$itemProductAttributeItem->ProductAttributeItemSpecification->bearings}}" placeholder="Bearings">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="variation-box">
                ...
                <div class="row g-3">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="input-wrap">
                            <label class="lable-head">Name</label>
                            <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][name]" id="" placeholder="e.g : P413641LR">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                        <div class="input-wrap">
                            <label class="lable-head">Stock</label>
                            <input type="number" class="form-control input-style" name="attribute[0][item][` + i + `][stock]" id="" placeholder="Stock">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                        <div class="input-wrap">
                            <label class="lable-head">Price</label>
                            <input type="number" class="form-control input-style" name="attribute[0][item][` + i + `][price]" id="" placeholder="Price">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-12 col-12">
                        <div class="select-btn-img">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                <div class="input-wrap">
                                    <label class="lable-head">Retrieve</label>
                                    <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][retrieve]" id="" placeholder="Retrieve">
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                <div class="input-wrap">
                                    <label class="lable-head">Weight</label>
                                    <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][weight]" id="" placeholder="Weight">
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-12">
                                <div class="input-wrap">
                                    <label class="lable-head">Gear Ratio</label>
                                    <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][gear_ratio]" id="" placeholder="Gear Ratio">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                <div class="input-wrap">
                                    <label class="lable-head">Line Cap.</label>
                                    <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][line_cap]" id="" placeholder="Line Cap.">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                                <div class="input-wrap">
                                    <label class="lable-head">Bearings</label>
                                    <input type="text" class="form-control input-style" name="attribute[0][item][` + i + `][bearings]" id="" placeholder="Bearings">
                                </div>
                            </div>
                        </div>
                    </div>
